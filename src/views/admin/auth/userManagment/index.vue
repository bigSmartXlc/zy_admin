    ...
    <template>
      <div claas="component-container">
        ...
        <el-table
          ...
          border
        >
          <el-table-column label="登录名称" prop="name"  />
          <el-table-column label="所属公司" prop="description"  />
          <el-table-column label="用户姓名" prop="companyName"  />
          <el-table-column label="组织机构" prop="companyName"  />
          <el-table-column label="手机号" prop="companyName"  />
