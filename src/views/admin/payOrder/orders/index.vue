...
// 组件依赖
import { Search, Plus, Edit, Refresh, View } from '@element-plus/icons-vue';
...
<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="name" label="cp单号" />
      <el-table-column prop="name" label="交易单号" />
      <el-table-column prop="name" label="用户名" />
      <el-table-column prop="name" label="角色" />
      <el-table-column prop="name" label="区服" />
      <el-table-column prop="name" label="子包" />
